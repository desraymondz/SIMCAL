      ...
      <main className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Convert your lecture schedule into calendar events
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 md:p-8 mb-6 border border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-3">
            ...
            <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
              <div className="mb-4">
                {accessToken ? (
                  <div className="flex items-center justify-between p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg mb-3">
                  ...
                  <button
                    className="w-full bg-white dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold px-6 py-3 rounded-lg shadow-md hover:shadow-lg hover:border-blue-500 dark:hover:border-blue-400 transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center gap-2"
